...
public class EditBox implements Command {
    ...
    public LinkedList<Box> edited;
    private LinkedList<Box> before = new LinkedList<>();
    ...
    public void execute(Properties properties) {
        ...
        if (properties.containsKey("text_size")) {
            ...
            style.setProperty(Styles.FontSize, properties.getProperty("text_size"));
            for (Box b : edited) {
                MainActivity.workbook.getStyleSheet().findStyle(b.topic.getStyleId()).setProperty(Styles.FontSize, properties.getProperty("text_size"));
            }
        } else if (properties.containsKey("bold")) {
            properties1.put("bold", properties.get("bold"));
            if (properties.get("bold").equals("true")) {
            ...
            if (properties.get("italic").equals("true")) {
            ...
            if (properties.get("strikeout").equals("true")) {
            ...
            String colorHex = "#" + (!Integer.toString(Color.red(Integer.parseInt(color)), 16).equals("0") ? Integer.toString(Color.red(Integer.parseInt(color)), 16) : "00")
                    + (!Integer.toString(Color.green(Integer.parseInt(color)), 16).equals("0") ? Integer.toString(Color.green(Integer.parseInt(color)), 16) : "00")
                    + (!Integer.toString(Color.blue(Integer.parseInt(color)), 16).equals("0") ? Integer.toString(Color.blue(Integer.parseInt(color)), 16) : "00");
    ...
    public void undo() {
        ...
        if (properties1.containsKey("box_color")) {
            ...
            style.setProperty(Styles.ShapeClass, properties1.getProperty("shape_name"));
            box.prepareDrawableShape();
        } else if (properties1.containsKey("line_color")) {
            int color = ((ColorDrawable) properties1.get("line_color")).getColor();
            String colorHex = "#" + (!Integer.toString(Color.red(color), 16).equals("0") ? Integer.toString(Color.red(color), 16) : "00")
                    + (!Integer.toString(Color.green(color), 16).equals("0") ? Integer.toString(Color.green(color), 16) : "00")
                    + (!Integer.toString(Color.blue(color), 16).equals("0") ? Integer.toString(Color.blue(color), 16) : "00");
            ...
            if (properties1.get("bold").equals("true")) {
                style.setProperty(Styles.FontStyle, Styles.FONT_WEIGHT_BOLD);
            } else {
                style.setProperty(Styles.FontStyle, "");
            }
        } else if (properties1.containsKey("italic")) {
            if (properties1.get("italic").equals("true")) {
                style.setProperty(Styles.FontStyle, Styles.FONT_WEIGHT_BOLD);
            } else {
                style.setProperty(Styles.FontStyle, "");
            }
        } else if (properties1.containsKey("strikeout")) {
            if (properties1.get("strikeout").equals("true")) {
                style.setProperty(Styles.TextDecoration, Styles.TEXT_DECORATION_LINE_THROUGH);
            } else {
                style.setProperty(Styles.TextDecoration, "");
            }
